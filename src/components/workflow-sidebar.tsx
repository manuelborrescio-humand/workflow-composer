    ...
    <div className="w-[320px] bg-white border-r border-[#E5E7EB] flex flex-col h-full shadow-sm">
            ...
            <button
              ...
              className={`w-full text-left px-3 py-2.5 rounded-lg transition-all duration-150 ${
                selectedTemplateId === template.id
                  ? "bg-[#F1F0FF] border border-[#6C63FF]/30 shadow-sm"
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className={`text-[12.5px] font-medium ${
                    selectedTemplateId === template.id ? "text-[#6C63FF]" : "text-[#1A1A2E]"
                  }`}>
                    {template.title}
                  </p>
      ...
      <div className="px-5 py-4 border-b border-[#E5E7EB]">
        ...
        <div className="flex gap-2 mb-3">
          <input
            ...
            className="flex-1 px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-[12px] text-[#1A1A2E] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#6C63FF]/20 focus:border-[#6C63FF] transition-all"
          />
          <button
            ...
            className={`px-4 py-2 rounded-lg text-[12px] font-semibold transition-all duration-150 ${
              instanceId && !isLoadingInstance
                ? "bg-[#6C63FF] text-white hover:bg-[#5B54E8] shadow-sm"
        ...
        {empresa ? (
          <div className="bg-gradient-to-br from-[#F8F9FA] to-[#F1F0FF] rounded-xl p-3.5 border border-[#E5E7EB]">
            <p className="text-[13px] font-semibold text-[#1A1A2E]">
              {empresa.nombre}
            </p>
            <div className="mt-2.5 space-y-1.5">
              <div className="flex items-center gap-2 text-[11px] text-[#6B7280]">
                <span className="w-4 text-center text-[#6C63FF]">S</span>
                <span>{empresa.servicios} servicios</span>
              </div>
              <div className="flex items-center gap-2 text-[11px] text-[#6B7280]">
                <span className="w-4 text-center text-[#6C63FF]">D</span>
                <span>{empresa.departamentos.length} departamentos</span>
              </div>
              <div className="flex items-center gap-2 text-[11px] text-[#6B7280]">
                <span className="w-4 text-center text-[#6C63FF]">U</span>
                <span>{empresa.usuarios} usuarios ({empresa.agentes} agentes)</span>
              </div>
            </div>
            <div className="mt-3 pt-2.5 border-t border-[#E5E7EB]/60">
              <p className="text-[10px] text-[#6C63FF] font-medium">
              ...
              <div
                ...
                className={`px-3 py-2 rounded-lg text-[11.5px] leading-relaxed ${
                  msg.role === "user"
                    ...
                    : "bg-[#F1F0FF] text-[#6C63FF] border border-[#6C63FF]/10"
                }`}
              >
                {msg.content}
              </div>
      ...
      <div className="px-5 py-4 border-t border-[#E5E7EB] bg-white">
        <textarea
          ...
          className="w-full h-[88px] px-3 py-2.5 bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl text-[12.5px] text-[#1A1A2E] resize-none placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#6C63FF]/20 focus:border-[#6C63FF] transition-all leading-relaxed"
        ...
        <button
          ...
          className={`w-full mt-2.5 py-2.5 px-4 rounded-xl text-[13px] font-semibold transition-all duration-150 ${
            inputText.trim() && !isGenerating
              ? "bg-[#6C63FF] text-white hover:bg-[#5B54E8] shadow-md shadow-[#6C63FF]/20"
              : "bg-[#F3F4F6] text-[#9CA3AF] cursor-not-allowed"
          }`}
        >
